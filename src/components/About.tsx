      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="gradient-card rounded-2xl p-8 md:p-12 shadow-card border border-border">
            ...
            <p className="text-lg text-foreground leading-relaxed mb-6">
              Specialized in <span className="text-accent font-semibold">IoT-based mobile solutions</span>, leveraging BLE, NFC, MQTT, Classic Bluetooth, FTP, and OTA updates for real-time device communication and seamless hardware integration.
            </p>
            
            <p className="text-lg text-foreground leading-relaxed">
              Experienced in RESTful API integration, Firebase, Retrofit, and third-party services. Demonstrated expertise in performance optimization, debugging, and memory management — delivering user-centric, reliable, and secure applications in Agile environments.
            </p>
